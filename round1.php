                ...
                <div class="table" style="width: 100%;">
                    <table style="width: 100%;" border="1" cellspacing="10">
                        <tr>
                          <td colspan="2" >
                            <div ><!-- Enter BetMoney -->
                              <input type="number" required id="money" style="color:whitesmoke;font-size: 3vh;border:none; height: 12vh; width: 100% ; background:transparent;"  placeholder="Enter betting Amount" name="money" onkeypress="return isNumberKey(event)" >
                            </div>
                          </td>
                        </tr>
                        <tr>
                            <td class="option">
                              <input type="radio" name="bet" value="1.25">
                              <div id="option1" align="center"> 1.25x</div>
                            </td>
                            <td class="option">
                              <input type="radio" name="bet" value="1.5">
                              <div id="option2" align="center">1.5x</div>
                            </td>
                        </tr>
                        <tr>
                            <td class="option">
                              <input type="radio" name="bet" value="1.75">
                              <div id="option3" align="center">1.75x</div>
                            </td>
                            <td class="option">
                              <input type="radio" name="bet" value="2">
            ...
            <div id="controlssolve">
                ...
                <table style="width: 90%;">
                    <tr>
                        ...
                        <td>
                            <div class="div1">
                              <button class="div2" id="nextBt">Submit</button>
                            </div>
                        </td>
                        <td>
                            <div class="div1">
...
<script type="text/javascript">
  ...
  function getQuestion(){
    ...
    function setVisibility(){
      ...
      document.getElementById("controlssolve").style.display = "block" ? "none" : "block";
      document.getElementById("controlsfirst").style.display = "block";
      document.getElementById("controlsbet").style.display = "none";
    ...
    function setBetting(){
      ...
      document.getElementById("controlssolve").style.display = "none";
      document.getElementById("divwooption").style.display = "none";
      document.getElementById("controlsfirst").style.display = "none";
      document.getElementById("divbetting").style.display = "block";
      document.getElementById("controlsbet").style.display = "block";
    }
