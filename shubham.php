        ...
        <div class="outer-border">
            <div class="inner-border">
              ...
              <div id="divbetting">
                    ...
                    <table style="width: 100%;" border="1" cellspacing="10">
                        <tr>
                          <td colspan="2" class="question">
                            <div ><!-- Enter BetMoney -->
                              <input type="number" required id="money" style="font-size: 10vh; height: 18vh; width: 100%" placeholder="Enter betting Amount" name="money" onkeypress="return isNumberKey(event)" >
                            </div>
                          </td>
                        </tr>
                        <tr>
               ...
               <div id="divwooption">
                <div class="meter red" style="margin-top: -2.95%;"><span id="progressbar" style="width: 0%;"></span></div>
                <div class="table" style="width: 100%;">
                    <table style="width: 100%;" border="1" cellspacing="10">
                        <tr>
            ...
            <div class="controls">
                <table style="width: 90%;">
                    <tr>
                        ...
                        <td>
                            <div id="div1">
                                <button id="div5">DIV2</button>
                            </div>
                        </td>
                        <td>
                            <div id="div1">
                               <!--  <button id="div6">DIV2</button> -->
                            </div>
                        </td>
                    </tr>
                </table>
